...
export function LoginPage() {
  ...
  return (
    <div className="min-h-screen pt-20 flex flex-col items-center justify-center px-4 relative z-10 w-full">
      ...
      >
        <GlassCard gradient="linear-gradient(137deg, #FF3D77 0%, #FF9D3C 100%)" className="p-6 sm:p-8 flex flex-col items-center text-center">
          ...
          <div className="space-y-6 w-full">
            {!IS_SUPABASE_CONFIGURED ? (
              <>
                <div className="rounded-2xl border border-yellow-400/20 bg-yellow-500/10 p-4 text-left text-sm text-yellow-100">
                  Supabase is not configured, so you can preview the app immediately without signing in.
                </div>
                <Button
                  variant="primary"
